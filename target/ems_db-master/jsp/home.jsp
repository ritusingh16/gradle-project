		...
		<table>
			...
			<c:forEach var="emp" items="${employees}">
				<tr>
					...
					<td>&nbsp;&nbsp;<a
						href="edit.jsp?code=${emp.code}&name=${emp.name}&city=${emp.city}">Edit</a>&nbsp;<a
						href="delete.jsp?code=${emp.code}">Delete</a></td>
				</tr>
			</c:forEach>
		</table>
		<a href="<%=request.getContextPath()%>/add.jsp" id="AddEmployeeLink">Add
			Employee</a> <a href="list">List Employees</a>
	</div>
</body>
</html>