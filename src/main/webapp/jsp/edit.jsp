	...
	<div class="smart-green">
		...
		<form method="post" modelAttribute="employeeCommand" action="update">
			<label>CODE:</label><input type="text" name="code"
				required="required" value="${fn:trim(employee.code)}" readonly /> <label></label>
			<br /> <label>NAME:</label> <input type="text" name="name"
				required="required" value="${fn:trim(employee.name)}"
				pattern="[A-Za-z]+" /> <br /> <label>CITY:</label> <input
				type="text" name="city" required="required"
				value="${fn:trim(employee.city)}" pattern="[A-Za-z]+" /> <br />
			<button type="submit" value="Edit Employee" id="EditEmployee">Edit
