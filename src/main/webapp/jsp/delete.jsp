...
<body>
	...
	<div class="smart-green">
		...
		<form method="post" action="/delete">
			<label>Are you sure for deletion</label><input type="text"
				name="code" required="required"
				value="<%=request.getParameter("code") %>" readonly /> <br />
			<!-- <input type="submit" value="Add Employee" id="SubmitEmployee" class="button"/> -->
			<button type="submit" value="Delete Employee" id="deleteEmployee">Delete
				Employee</button>
		</form>
