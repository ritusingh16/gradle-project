	...
	<div class="smart-green">
		...
		<form method="post" action="add">
			<label>CODE:</label><input type="text" name="code"
				required="required" pattern="[0-9]+" /> <br /> <label>NAME:</label>
			<input type="text" name="name" required="required"
				pattern="[A-Za-z]+" /> <br /> <label>CITY:</label> <input
				type="text" name="city" required="required" pattern="[A-Za-z]+" /> <br />
			<!-- <input type="submit" value="Add Employee" id="SubmitEmployee" class="button"/> -->
			<button type="submit" value="Add Employee" id="SubmitEmployee">Add
				Employee</button>
		</form>
